...
Full-stack social platform for reverts to find community and connect. Journey-based compatibility scoring for buddy matching, JWT auth with refresh token rotation, Flutter frontend with feed, DM, and onboarding flows.
